...
export const STR = {
  ...
  signingIn:      { en: 'Signing in with Google…', ar: 'جاري تسجيل الدخول عبر Google…' },
  errName:        { en: 'Enter your full name (2+ characters)', ar: 'أدخل اسمك الكامل (حرفان على الأقل)' },
  errDept:        { en: 'Enter your department', ar: 'أدخل القسم' },
  completeProfile:{ en: 'Complete your profile', ar: 'أكمل ملفك الشخصي' },
  lastStep:       { en: 'One last step before you start!', ar: 'خطوة أخيرة قبل البدء!' },
  profileHint:    { en: 'This appears on the leaderboard and to colleagues.',
                    ar: 'هذه المعلومات تظهر في جدول الترتيب وتوقعات الزملاء.' },
  startPredicting:{ en: 'Start predicting', ar: 'ابدأ التوقعات' },
  errSaveProfile: { en: 'Could not save profile. Try again.', ar: 'تعذّر حفظ الملف الشخصي. حاول مرة أخرى.' },
