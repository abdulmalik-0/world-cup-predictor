 ...
 * a dropdown, and a smaller Malaz logo so the shrunk clip never overlaps it.
 */
...
function MalazLogo() {
  return (
    <a href="/" className="flex items-center gap-2 select-none shrink-0">
      <img src="/malaz_logo.svg" alt="Malaz" className="h-5 sm:h-7 md:h-8 brightness-0 invert" />
    </a>
  );
}
